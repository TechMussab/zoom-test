...
const server_url = process.env.NODE_ENV === 'production' ? 'https://video.sebastienbiollo.com' : 'http://172.20.1.93:4001'
// const server_url = process.env.NODE_ENV === 'production' ? 'https://video.sebastienbiollo.com' : 'localhost:4001'
...
class Video extends Component {
  ...
  getPermissions = async () => {
    try {
      ...
      console.log('this.videoAvailable: ' + this.videoAvailable)
      await navigator.mediaDevices.getUserMedia({ audio: true })
        .then(() => this.audioAvailable = true)
        .catch(() => this.audioAvailable = false)
      console.log('this.audioAvailable: ' + this.audioAvailable)
      ...
      console.log('Exc in video.js catch')
      console.log(e)
    }
  }
  ...
  getMedia = () => {
    this.setState({
      ...
      try {
        ...
        console.log('exc in video line 103: ' + e)
      }
    })
  }
  ...
  connectToSocketServer = () => {
    try {
      ...
      console.log('connection done socket: ' + JSON.stringify(socket) + ' socketID:' + socketId)
    } catch (e) {
      console.log('exc line 284: ' + e)
    }
    let counter = 0
